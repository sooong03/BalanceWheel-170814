...
public class MyCalendarAdapter extends CalendarViewAdapter {
    ...
    public MyCalendarAdapter(Context context, OnSelectDateListener onSelectDateListener, CalendarAttr.CalendayType calendarType, IDayRenderer dayView) {
